...
version: "1.3.1",
	...
	groupAlias: "DatumUser",
	guestAlias: "DatumGuest",
	...
	images: {
		...
		login: "dist/img/datum-new-logo1b.png",
		sidebar: "dist/img/datum-new-logo1b.png",
		...
		carousel: {
			...
			interval: 7.5,
			images: [
				"dist/img/carosel1.jpg",
				"dist/img/carosel2.jpg",
				"dist/img/carosel3.jpg",
			],
		},
	},
	...
	styles: {
        ...
        loginForm: {
            background: "url(/dist/img/sidebar-bk.jpg) top right",
            padding: "1em",
            fontColor: "white",
        },
        button: {
